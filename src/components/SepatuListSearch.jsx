...
export default function ShoeList({ shoes, searchTerm, selectedCategory }) {
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  {colorOptions.map((color, index) => (
                    <button
                      key={index}
                      className={`w-6 h-6 rounded-full ${color.code} hover:ring-2 hover:ring-offset-2 hover:ring-gray-400 transition-all`}
                      title={color.name}
